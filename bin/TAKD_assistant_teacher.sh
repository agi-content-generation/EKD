...
SAVE_DIR=${1:-"checkpoints/TAKD_assistant_teacher_model_iwslt14"}
LOG_FILE=${2:-"TAKD_assistant_teacher_model_iwslt14.txt"}
DATA_SET_DIR=${3:-"data-bin/iwslt14.tokenized.de-en"}
TEACHER_MODEL_PATH=${4:-"checkpoints/senior_teacher_model_iwslt14/checkpoint_best.pt"}
